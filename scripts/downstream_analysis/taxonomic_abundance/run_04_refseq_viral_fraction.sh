#!/bin/bash -l
#SBATCH --job-name=refseq_viral_frac_std
...
python scripts/downstream_analysis/taxonomic_abundance/04_standardise_refseq_matrix.py \
  --matrix results/kraken_bracken/refseq_kraken_bracken/bracken_Refseq/bracken_merged/refseq_viral_G_fraction.tsv \
  --meta results/kraken_bracken/refseq_kraken_bracken/bracken_Refseq/bracken_merged/refseq_viral_G_meta.tsv \
  --output results/downstream/refseq/tables/refseq_viral_G_fraction_samples_x_taxa.tsv
